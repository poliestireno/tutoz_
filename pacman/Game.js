...
function welcomeScreen(){
	...
	ctx.fillText("Pulsa s para empezar", CANVAS_WIDTH/2, 220);
	ctx.font = "14px monospace";
	ctx.fillText("DESARROLLADO BY: ZI WANG, BINGYING XIA", CANVAS_WIDTH/2 , CANVAS_HEIGHT/20*19);
...
function winMessage(){
	...
	ctx.fillStyle = "white";
	ctx.font = "16px monospace";
	ctx.fillText("Enhorabuena de la buena!", CANVAS_HEIGHT/2, CANVAS_HEIGHT/2+6);
	ctx.font = "12px monospace";
	ctx.fillText("pulsa R para jugar again", CANVAS_HEIGHT/2, CANVAS_HEIGHT/2+28);
}
