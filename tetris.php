...
<form id="form1" method="post" class="form-horizontal" enctype="multipart/form-data" action="contadorapertura.php">
    ...
    <script>
        ...
        function drawUI() {
            ...
            g.fillStyle = textColor;
            g.font = smallFont;
            g.fillText(' Lineas para ', scoreX, scoreY);
            g.fillText('abrir el sobre ', scoreX, scoreY + 30);
            g.fillText('     '+scoreboard.getLines()+'/'+lineasTotales, scoreX, scoreY + 60);
            //g.fillText('lineas: ' + , scoreX, scoreY + 90);
