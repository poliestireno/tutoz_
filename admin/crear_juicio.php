...
if(isset($_POST['sel11']))
{
  ...
  modificarDesactivarJuicios($dbh,$IdAsignatura);
  insertarJuicio($dbh,$IdAsignatura,$name,$opciones,$descrip);
  
    $lastInsertId = $dbh->lastInsertId();
    if($lastInsertId)
    {

        echo "<script type='text/javascript'>alert('Juicio creado correctamente!');</script>";
    }
    else
    {
        echo "<script type='text/javascript'>alert('Error al crear el juicio.');</script>";        
    }
...
<body>
    ...
    <?php include('includes/leftbar.php');?>
        <div class="content-wrapper">
						...
						<h1 class="text-center text-bold mt-2x">Crear Juicio</h1>
        ...
        ?>
                            ...
                            <input type="text" maxlength = "499" name="descrip" class="form-control" value="¿CÓMO HA IDO LA CLASE?" required>
                                ...
                                <button class="btn btn-primary" name="submit" type="submit">Crear Juicio</button>
