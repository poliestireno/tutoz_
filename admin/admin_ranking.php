...
<h3>Curso/clase (<?php echo $tituloClase;?>)</h3>
...
foreach ($aToRetos as $reto) 
{
    ...
    $insertadoTituloCampanaActual=1;
      ...
      ?>
      <td><a  data-toggle="tooltip" title="Ver detalle del reto en otra ventana" href="admin_detalle_reto.php?idr=<?php echo $reto['ID']?>&idc=<?php echo $idCur?>" target="_blank"><?php echo $reto['NOMBRE'];?></a></td>
       <?php
