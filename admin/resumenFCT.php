...
<?php
echo ' NÚMERO DE ALUMNOS, PRÁCTICAS, CICLOS, PERIODO ACTUAL, NUMERO APTOS, EMPRESAS POR CICLO,...,';
echo ' ACCESO A LAS TABLAS';
?>
  ...
  <div>
    <div class="text-center" style="padding-bottom:10px;">
      <img class="img-fluid mx-auto d-block" src="img/tablas_FCT.png">
    <h5>diagrama</h5>
    </div>
  </div>
