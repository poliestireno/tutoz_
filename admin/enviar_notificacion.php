...
{
  mandarNotificacion($dbh,'Admin',getAlumnoFromID($dbh,$idAlu)['CORREO'],$_POST['texto']);
...
<script type="text/javascript">
  ...
  {
      document.getElementById("form2").action="enviar_notificacion.php";
  ...
  <?php include('includes/leftbar.php');?>
    <div class="content-wrapper">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <h3 class="page-title">Enviar Notificación</h3>
            <div class="row">

                <div class="col-md-12">
                <div class="panel panel-default">
                  <div class="panel-heading">Enviar Notificación<?php 
